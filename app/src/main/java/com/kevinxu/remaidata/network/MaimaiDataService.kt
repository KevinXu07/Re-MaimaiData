...
interface MaimaiDataService {
    ...
    /**
     * fetch app update info from this fork
     */
    @Headers("urlName:https://raw.githubusercontent.com")
    @GET("/KevinXu07/Re-MaimaiData/master/update.json")
    fun getAppUpdateInfo(): Observable<JsonElement>

    /**
     * fetch data update info from the existing data source
     */
    @Headers("urlName:https://bucket-1256206908.cos.ap-shanghai.myqcloud.com")
    @GET("/update.json")
    fun getDataUpdateInfo(): Observable<JsonElement>
