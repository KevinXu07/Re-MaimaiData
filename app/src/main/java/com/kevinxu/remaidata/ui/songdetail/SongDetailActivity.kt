package com.kevinxu.remaidata.ui.songdetail
...
import com.kevinxu.remaidata.databinding.ActivitySongDetailBinding
...
import com.kevinxu.remaidata.repository.AliasRepository
...
import com.kevinxu.remaidata.utils.setCopyOnLongClick
import com.kevinxu.remaidata.utils.setShrinkOnTouch
    ...
    private fun setVersionImage(view: ImageView, addVersion: String) {
        ...
        with(addVersion) {
            when {
                ...
                startsWith("260") -> versionDrawable = R.drawable.maimaidx_circle
            }
        }
